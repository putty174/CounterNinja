...
namespace CounterNinja
{
    public class GameOverScreen : GameScreen
    {
        ...
        public GameOverScreen(GameScreen levelToLoad, double waitTime = 3)
        {
            this.levelToLoad = levelToLoad;
            this.waitTime = waitTime;
        }

        public GameOverScreen(GameScreen levelToLoad, GameScreen extraScreen, double waitTime)
        ...
        {
            base.LoadContent();
            screen = ScreenManager.Content.Load<Texture2D>("GameOver/GameOver");
